      ...
      <section className="contact" id="contact">
        <div className="navigation__disabler" style={contactStyle} onClick={closeWarning}>
            <div className="contact__warning">
                ...
                <p className='contact__warning__text'>Esta função está indisponível no momento, mas já estou trabalhando para consertá-la o mais rápido possível, enquanto isso você pode me contatar por outros métodos.</p>
